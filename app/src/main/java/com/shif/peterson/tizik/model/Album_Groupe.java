...
public class Album_Groupe {
    ...
    public Album_Groupe(String id_albumGroupe, String id_groupe, String titre, String description, int nombre_audio, String url_demo, String url_poster, String date_creation, String date_venteSignature, boolean is_free, double prix, boolean is_actif, String created_by, String date_creted) {
