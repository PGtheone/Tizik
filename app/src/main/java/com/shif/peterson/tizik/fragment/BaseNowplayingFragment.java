...
import com.shif.peterson.tizik.adapter.BaseQueueAdapter;
import com.shif.peterson.tizik.timely.TimelyView;
...
import widgets.CircularSeekBar;
import widgets.PlayPauseButton;
import widgets.PlayPauseDrawable;
...
public class BaseNowplayingFragment extends Fragment {
    ...
    //todo really need to check that out
